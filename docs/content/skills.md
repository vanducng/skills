...
`vd:superwhisper`, `vd:gog`, `vd:jira`, `vd:issue-invoice`, `vd:computer-clean`, `vd:worktree`, `vd:herd-worktree`, `vd:herdr`, `vd:gopass`, `vd:journal`, `vd:obsidian-vault`, `vd:workbench`, `vd:braze`, `vd:smartsheet`, `vd:voice-agent`
