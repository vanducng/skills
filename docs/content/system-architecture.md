...
| `docs/` | Astro Starlight docs site for `skills.vanducng.dev`. | `docs/astro.config.mjs`, `docs/content/*.md` |
...
6. Astro Starlight builds `docs/` into `docs/dist/` for GitHub Pages.
