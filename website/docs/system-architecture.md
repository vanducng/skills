...
| `website/` | Astro Starlight docs site for `skills.vanducng.dev`. | `website/astro.config.mjs`, `website/docs/*.md` |
...
6. Astro Starlight builds `website/` into `website/dist/` for GitHub Pages.
