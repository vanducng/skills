...
### Changed
- `skills/excalidraw/SKILL.md` 1.0.0 → 1.1.0 — added compact legend guidance for diagrams where colors, shapes, stroke styles, or arrow colors encode meaning. Legends are capped to 3-6 used semantics, include default arrow-type entries, and are explicitly checked for clarity so they explain the diagram without becoming clutter.
