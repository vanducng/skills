...
### Presentation Tasks
**→ open-design** (external skill — HTML decks)

- Pitch decks and slide presentations are HTML artifacts; use `open-design`.
...
| "Create a pitch deck" | open-design |
...
Use **logo + cip + open-design** when:
- Brand pitch: generate logo, create CIP mockups, build pitch deck (deck via open-design)
