---
name: open-design
description: "Generate polished single-file HTML design artifacts: landing pages, SaaS marketing pages, dashboards, mobile app screens, posters, social carousels, marketing emails, pricing pages, docs pages, decks/PPT slides, e-guides, kanban boards, weekly updates, invoices, OKRs, and more. Composes production skills and brand-grade design systems sourced live from github.com/nexu-io/open-design. Use when the user asks to design, mock up, prototype, sketch, draft, build, or render a visual web artifact; picks a brand/style direction; says 'in the style of <brand>'; wants a hero, section, component, GitHub README/repo hero banner, or browser-reviewable HTML. Produces editable HTML/CSS/SVG and auto-opens results for review. For AI-generated raster brand imagery such as logos, photoreal CIP/business-card mockups, or social photos, use marketing-design instead."
license: MIT
