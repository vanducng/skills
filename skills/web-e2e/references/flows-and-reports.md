...
- Destination: the hook-injected Reports path when present (`.work/reports/e2e-...md`), else `<repo>/.e2e/runs/<yymmdd-hhmm>-<flow>.md`. Tool-neutral — works the same under Codex or plain shell.
