...
def _build_codex_image_prompt(
    *,
    ...
    return (
        ...
        "and do not invent extra services or steps. Before saving, run a visual QA pass: "
        "remove any stray, dangling, or unfinished connector/divider line; every line must "
        "either be a card border, attach cleanly to a node, end with an arrowhead, or stop "
        "at an intentional container edge.\n\n"
        f"{reference_note}\n\n"
        f"## User description\n{description}\n\n"
        f"## Active preset\n{preset}\n\n"
