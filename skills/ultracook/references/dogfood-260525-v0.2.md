...
**Expected:** Codex ultracook reads existing goal.yaml + state.json, prints
...
- [ ] VD_ULTRACOOK_DEPTH recursion guard did NOT trip
...
If keystone passes: open Phase 5 completion PR + bump skills/ultracook/SKILL.md version metadata to 0.2.0 if not already. Update CHANGELOG.md.
