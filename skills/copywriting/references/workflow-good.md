...
1. **Screenshots provided** → Use `vd:omnimedia` skill for detailed context analysis
2. **Videos provided** → Use `vd:omnimedia` video-analysis for comprehensive context
