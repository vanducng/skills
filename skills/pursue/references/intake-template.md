...
```
PURSUE_TARGET_KIND   →  target.kind
PURSUE_ACTION_SHAPE  →  actions[0]  (prepended; rest from profile)
PURSUE_BRANCH        →  project.branch + worktree branch name
PURSUE_AUTONOMY      →  autonomy
```
