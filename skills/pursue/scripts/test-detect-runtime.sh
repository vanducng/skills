...
run "override codex-exec"        "codex-exec" 0 PURSUE_RUNTIME=codex-exec
run "override claude-code"       "claude-code" 0 PURSUE_RUNTIME=claude-code
...
run "CODEX + exec contract"      "codex-exec" 0 CODEX_SESSION_ID=abc PURSUE_EXEC=1
...
run "codex on PATH + exec"       "codex-exec" 0 PURSUE_EXEC=1
make_cli claude
