...
- Keep provider SDK calls in provider modules, not command registration.
- Pin provider SDKs exactly when their generated types and endpoints define observable CLI behavior.
