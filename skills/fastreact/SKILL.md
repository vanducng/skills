...
Lock the look before writing app code. Save artifacts under `.workbench/visuals/{app-slug}/` (or `plans/visuals/{app-slug}/`), where `{app-slug}` is a kebab-case name for the app/feature.
