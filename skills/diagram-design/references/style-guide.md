...
> **Note:** The pre-baked example HTML files in `assets/` are reference artifacts and may preserve an earlier skin. New diagrams produced by the skill should use the tokens above; run the packaged skin linter when changing shipped examples.
