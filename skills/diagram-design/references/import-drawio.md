...
Load this file when the user points at a `.drawio`, `.drawio.xml`, `.drawio.png`, or `.drawio.svg` file and wants a diagram out of it - "convert this drawio", "redraw this diagram", "make this presentable", or "この drawio をきれいにして".
...
[`assets/example-import-drawio.html`](../assets/example-import-drawio.html) demonstrates this procedure with 12 nodes, 8 edges, and 2 container groups at `format=html`, `size=doc-inline`, `detail=balanced`, `audience=mixed`.
