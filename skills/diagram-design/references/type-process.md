...
The extended process variant is fully described by the following inputs. Every coordinate in the rendered SVG is derivable from this block via §2 + §3 + §4. This is the canonical proof that the parametric contract works end-to-end.
...
nodes:
  ...
  - { lane: "IT",  step: 10, title: "Upload Survey Platform / SDMX", sub: "Results → Published",
