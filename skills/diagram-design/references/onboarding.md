...
1. `$HOME/.pi/agent/skills/<skill-name>/` and `$HOME/.agents/skills/<skill-name>/` (user installs)
...
> *"Onboard diagram-design from my design system at `$HOME/projects/brand/design-tokens/`"*
