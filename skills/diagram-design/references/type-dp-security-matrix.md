...
- `assets/example-dp-security-matrix.html` - minimal light (Survey Platform canonical: 4 roles × 8 components, focal at Data Consumers × Trino aggregated). Gallery default.
